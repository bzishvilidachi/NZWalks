...
{
    /// <inheritdoc />
    public partial class SeedDifficultiesandRegionsdata : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0a749443-8008-4d72-ad50-301279b1a509"), "Easy" },
                    { new Guid("5148a5e2-6fad-48f6-9fe3-aaee1a0af62e"), "Medium" },
                    { new Guid("792d4669-7603-4feb-8eaf-40c02e9e1281"), "Hard" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0a749443-8008-4d72-ad50-301279b1a509"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("5148a5e2-6fad-48f6-9fe3-aaee1a0af62e"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("792d4669-7603-4feb-8eaf-40c02e9e1281"));
